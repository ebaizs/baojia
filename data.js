...
const kongjianchanpin = {
    home: [
        { space: "客餐厅", name: ["平面吊顶", "直线吊顶", "双层叠级石膏线", "顶面石膏线", "窗帘盒", "影视墙造型", "墙面基层处理", "墙面乳胶漆", "顶面基层处理", "顶面乳胶漆", "木饰面墙板造型", "沙发背景造型", "其它造型"] },
    ...
    commercial: [
        ...
        { space: "前台", name: ["前台区地砖", "玻璃地弹门", "前台接待台", "等候区沙发", "开关插座", "监控系统", "门禁系统"] },
